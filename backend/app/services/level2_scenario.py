"""
Level 2 Cybersecurity Attack Analysis Data Provider
Scenario: Problem 11 — The Fake Invoice at the Regional Credit Union
Fictional defensive training scenario with synthetic/demo data only.
"""

LEVEL2_SCENARIO_DATA = {
...
def get_level2_scenario_data():
    return LEVEL2_SCENARIO_DATA
